...
The reports generated by the RMT SHALL have the list of data items used.
...
##### REQ-TRAQ-SWL-23 Simplified reports

The RMT SHALL allow generating a table report containing just:
- the requirement IDs,
- safety impact, if not `None`,
- derived, if `Yes`.
...
##### REQ-TRAQ-SWL-24 inheritance 1

The RMT SHALL enforce the Safety impact of a requirement is passed on to the children requirement(s) if not `None`.

###### Attributes:
- Rationale: x
- Verification: Unit test
- Safety impact: None
- Parents: REQ-TRAQ-SWH-22

##### REQ-TRAQ-SWL-25 inheritance 1

The RMT SHALL enforce the Safety impact of a requirement originates from at least one parent requirement.
